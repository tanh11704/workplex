                        ...
                        <div class="row gx-0">
                            <div class="col-12 col-md-8 col-xl-9">
                                ...
                                >
                                    ...
                                    />
                                    <i
                                        class="bnc-ico lni lni-search-alt"
                                    ></i>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-xl-3">
                                <div
                                    class="form-group mb-0 align-items-center"
                                >
                                    <button
                                        type="submit"
    ...
    <section class="bg-light">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div
                        class="row align-items-center justify-content-between mx-0 bg-white rounded py-4 mb-4"
                    >
                        <div
            ...
            <div class="row align-items-center g-3">
                @foreach($jobs as $job)
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div
                            class="border rounded bg-white position-relative d-block"
                        >
