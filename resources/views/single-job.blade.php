                            ...
                            <div class="caption ps-3">
                                <div class="title">
                                    <h4 class="mb-0 fs-6">
                                        {{ $job->title }}
                                        <img
                                            src="{{ asset('assets/img/verify.svg') }}"
                                            class="ms-1"
                                            width="12"
                                            alt=""
                                        />
                            ...
                            <div>
                                <form style="display:inline;" action="{{ route('jobs.apply') }}" method="post">
                                    ...
                                    @if($appliedJob > 0)
                                        <button
                                            href="#"
                                            class="btn py-3 px-4 rounded theme-cl fs-6 shadow-none"
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="rounded mb-4">
                        <div class="pe-3">
                            ...
                            <div class="jobdetails mb-3">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2 me-4 ms-lg-0 me-lg-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="mb-0 ms-3"
                                                >Strong core PHP Hands on experience.</span
                                                >
                                            </div>
                                        </div>
                                        <div class="mb-2 me-4 ms-lg-0 me-lg-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="mb-0 ms-3"
                                                >Strong Expertise in CodeIgniter Framework .</span
                                                >
                                            </div>
                                        </div>
                                        <div class="mb-2 me-4 ms-lg-0 me-lg-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="mb-0 ms-3"
                                                >Understanding of MVC design pattern.</span
                                                >
                                            </div>
                                        </div>
                                        <div class="mb-2 me-4 ms-lg-0 me-lg-4">
                              ...
                              technology exposure of Codeigniter .</span
                                                >
                                            </div>
                                        </div>
                                        <div class="mb-2 me-4 ms-lg-0 me-lg-4">
                              ...
                              such as JavaScript, HTML5, and CSS3</span
                                                >
                                            </div>
                                        </div>
                                        <div class="mb-2 me-4 ms-lg-0 me-lg-4">
                              ...
                              control tools and of developing web
                              services.</span
                                                >
                                            </div>
                                        </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="job-apply-form bg-white border rounded py-3 px-4">
                        <h6 class="mb-3 text-black">Intrested in this job?</h6>
                        <form action="">
                            <div class="form-group mb-2">
                                <label class="text-dark mb-1">First Name</label>
                                <input
                                    type="text"
                                    class="form-control"
                            ...
                            <div class="form-group mb-2">
                                <label class="text-dark mb-1">Your Email</label>
                                <input
                                    type="email"
                                    class="form-control"
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div class="custom-file">
                                    <input
                                        ...
                                        id="customFile"
                                    />
                                    <label class="custom-file-label theme-cl" for="customFile"
                                    >Choose file</label
                                    >
                                </div>
                            </div>
                            <div class="form-group mb-2">
                                <div class="d-flex align-items-center">
                                    <input
                                        ...
                                        name="term_condition"
                                    />
                                    <label>I agree to pirvacy policy</label>
                                </div>
                            </div>
                ...
                @foreach($related_jobs as $job)
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                        <div class="border rounded bg-white position-relative d-block">
                            ...
                            <div
                                class="pb-4 px-3 d-flex align-items-center justify-content-between"
                            >
                                <div><i class="lni lni-wallet me-1"></i>{{ $job->salary}}</div>
                                <div><i class="lni lni-timer me-1"></i>{{ $job->created_at->diffInDays() }} days ago</div>
                            </div>
                        </div>
                    </div>
                @endforeach
